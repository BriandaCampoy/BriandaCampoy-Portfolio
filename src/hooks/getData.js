...
const schools = {
  schools: [
    ...
    },
    {
      ...
      aboutTheInstitution:
        'Platzi is effective online education. Technology content, up-to-date and of high quality, accessible to all.',
  ...
  courses: [
    ...
    },
    {
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The architecture of a computer.\n* How the internet works.\n* The world of networks and the cloud.\n* The software industry.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599529/portfolio/assets/img_school/Platzi/diploma-ingenieria_page-0001_gjm5rz.jpg'
      ]
    },
    {
      id: 3,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The Role of the Software Architect\n* Analyze software requirements\n* Identify different styles of Software Architecture\n* Make decisions in an evolutionary way',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681713222/portfolio/assets/img_school/Platzi/diploma-arquitectura-software_page-0001_ytiqfl.jpg'
      ]
    },
    {
      id: 'group-1',
      ...
      courses: [
        {
          ...
          aboutTheCourse:
            '### In this course, I learned about:\n* Develop an online store with React\n* Bring a layout from HTML and CSS to React\n* Create a website with React.js',
          certifications: [
            'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599532/portfolio/assets/img_school/Platzi/diploma-react-practico_page-0001_b53dvu.jpg'
          ]
        },
        {
          id: 5,
          ...
          aboutTheCourse:
            '### In this course, I learned about:\n* The advantages of responsive design and CSS architectures\n* How the HTML and CSS code works in the web page\n* The most important HTML tags\n* CSS properties and selectors',
          certifications: [
            'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599528/portfolio/assets/img_school/Platzi/diploma-frontend-developer-practico_page-0001_ab5i9f.jpg'
          ]
        },
        {
          id: 6,
          ...
          aboutTheCourse:
            '### In this course, I learned about:\n* The advantages of handling state with React Hooks\n* Throw events to react to user interactions\n* The difference between components, elements and tag\n* How to create an interactive webapp with React.js',
          certifications: [
            'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681601013/portfolio/assets/img_school/Platzi/diploma-react_page-0001_xnkufe.jpg'
          ]
        },
        {
          id: 7,
          ...
          aboutTheCourse:
            '### In this course, I learned about:\n* The evolution of components in React\n* Different ways to create and update state in React\n* Imperative, declarative, independent, compound and dynamic states\n* Maintainability and readability of your components',
          certifications: [
            'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599531/portfolio/assets/img_school/Platzi/diploma-react-estado_page-0001_kdetdp.jpg'
          ]
        },
        {
          id: 8,
          ...
          aboutTheCourse:
            '### In this course, I learned about:\n* How to integrate React Router to new or old projects\n* Create dynamic routes, public or private\n* Optimize the UX of an app with transmission of states through routes.',
          certifications: [
            'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599532/portfolio/assets/img_school/Platzi/diploma-react-router_page-0001_on6vri.jpg'
          ]
        },
        {
          id: 9,
          ...
          aboutTheCourse:
            '### In this course, I learned about:\n* Avoid prop drilling with and without React Context\n* Compare React Hooks with other patterns like Render Props and HOCs\n* React principles like state placement and boring code\n* How to write healthy code with component composition in React',
          certifications: [
            'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599533/portfolio/assets/img_school/Platzi/diploma-react-patrones-render_page-0001_kjlcpb.jpg'
          ]
        },
        {
          id: 10,
          ...
          aboutTheCourse:
            '### In this course, I learned about:\n* I use CSS variables for the colors, fonts and sizes of an application\n* Layout of web pages with responsive design\n* Views and components of your web page',
          certifications: [
            'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599528/portfolio/assets/img_school/Platzi/diploma-frontend-developer-practico_page-0001_ab5i9f.jpg'
          ]
        },
    ...
    },
    {
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* Basic use of figma and its tools\n* Creation and manipulation of components in figma.\n* How to create the prototype of an application.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599528/portfolio/assets/img_school/Platzi/diploma-figma_page-0001_qqxqo0.jpg'
      ]
    },
    {
      id: 35,
      ...
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599530/portfolio/assets/img_school/Platzi/diploma-java-basico_page-0001_woa89n.jpg'
      ]
    },
    {
      id: 36,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The basic commands to use the terminal.\n* Customization of the terminal according to the needs of the project.\n* Manipulate files and directories from the terminal.\n* Create aliases and environment variables to save time.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599532/portfolio/assets/img_school/Platzi/diploma-terminal_page-0001_orvbei.jpg'
      ]
    },
    {
      id: 37,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* Version Control in Projects with Git\n* Work in Teams Collaboratively\n* Using Custom Domains with GitHub Pages\n* How to install Git on the operating system',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599529/portfolio/assets/img_school/Platzi/diploma-git-github_page-0001_syf4em.jpg'
      ]
    },
    {
      id: 38,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* Layout the Header, the Main and the Footer\n* Create the styles of a project\n* Make labels for a project\n* Layout a static blog',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599531/portfolio/assets/img_school/Platzi/diploma-practico-css_page-0001_hq7u6a.jpg'
      ]
    },
    {
      id: 39,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* Connect JavaScript with HTML.\n* Develop software with a professional workflow.\n* Deploy projects to the internet with GitHub Pages.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599530/portfolio/assets/img_school/Platzi/diploma-javascript-practico_page-0001_rltwse.jpg'
      ]
    },
    {
      id: 40,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* Connect JavaScript with HTML.\n* Develop software with a professional workflow.\n* Deploy projects to the internet with GitHub Pages.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599530/portfolio/assets/img_school/Platzi/diploma-javascript-practico_actualizado__page-0001_y14qpc.jpg'
      ]
    },
    {
      id: 41,
      ...
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599529/portfolio/assets/img_school/Platzi/diploma-html-practico_page-0001_huhdnl.jpg'
      ]
    },
    {
      id: 42,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The basics of JS\n* The history of javascript\n* How to make decisions and validate them\n* Work with objects',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681713519/portfolio/assets/img_school/Platzi/diploma-basico-javascript_page-0001_ouwges.jpg'
      ]
    },
    {
      id: 43,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The behavior of objects in JavaScript\n* Clone object properties in JavaScript\n* Create functions that do not mutate external data\n* Make function composition',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599530/portfolio/assets/img_school/Platzi/diploma-javascript-practico_actualizado__page-0001_y14qpc.jpg'
      ]
    },
    {
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The different object-oriented programming languages\n* Problems for object-oriented project development\n* The operation of objects\n* The operation of the classes',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599531/portfolio/assets/img_school/Platzi/diploma-oop_page-0001_b2zujh.jpg'
      ]
    },
    {
      id: 45,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* Animable properties in CSS.\n* Transformations of HTML elements in 2D and 3D.\n* The transitions using timing functions.\n* Improved CSS performance and accessibility.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599533/portfolio/assets/img_school/Platzi/diploma-transformaciones-transiciones-css_page-0001_yifada.jpg'
      ]
    },
    {
      id: 46,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* How to build complex layouts in a simple and responsive way\n* Position items and containers\n* Control items across rows and columns\n* Distinguish the different CSS Grid properties',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599527/portfolio/assets/img_school/Platzi/diploma-css-grid_page-0001_eoc1xm.jpg'
      ]
    },
    {
      id: 47,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The concepts of asynchronism with JavaScript.\n* The concepts of Event Loop, Callbacks and promises.\n* Application of asynchronous functions to a project to interact with an API.\n* How to create a landing page and deploy to GitHub Pages.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599527/portfolio/assets/img_school/Platzi/diploma-asincronismo-js_page-0001_wjmtfu.jpg'
      ]
    },
    {
      id: 48,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* How to implement the consumption of REST API with JavaScript.\n* Optimization of the loading time of a project.\n* Creation of loading skeletons to improve the UX of an application,\n* Infinite scroll implementation.\n* Use of Local Storage to increase the response speed of your application.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599527/portfolio/assets/img_school/Platzi/diploma-api-profesional_page-0001_ehujrt.jpg'
      ]
    },
    {
      id: 49,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* Consume a REST API with JavaScript.\n* How the communication flow between Frontend and Backend works\n* Make asynchronous requests using fetch.\n* Fundamentals of API consumption',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599527/portfolio/assets/img_school/Platzi/diploma-api_page-0001_bcizvs.jpg'
      ]
    },
    {
      id: 50,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* How to create a project with connection to a real API.\n* How to develop a Single Page Application with hash navigation.\n* Create a movie search engine from TheMovieDB',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599527/portfolio/assets/img_school/Platzi/diploma-api-practico_page-0001_rvstn1.jpg'
      ]
    },
    {
      id: 51,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* How to use animation and keyframe in CSS.\n* How to build interactive counters with CSS.\n* How to draw characters in an application with CSS.\n* Optimize the performance of web animations.',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599532/portfolio/assets/img_school/Platzi/diploma-animaciones-css_page-0001_e7jb20.jpg'
      ]
    },
    {
      id: 52,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The flow to develop web applications\n* Install PHP on any operating system\n* Set up a development environment with tools like XAMPP\n* The basic syntax, typing, and operators in PHP',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599531/portfolio/assets/img_school/Platzi/diploma-php_page-0001_jup6yt.jpg'
      ]
    },
    {
      id: 53,
      ...
      aboutTheCourse:
        '### In this course, I learned about:\n* The semantics of HTML\n* Create Static Websites with HTML and CSS3\n* The anatomy of an HTML element\n* Apply styles using CSS3',
      certifications: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681599529/portfolio/assets/img_school/Platzi/diploma-html-css_page-0001_xiiysp.jpg'
      ]
    },
    {
      id: 54,
...
const projects = {
  projects: [
    ...
    },
    {
      ...
      GithubRepository:
        'https://github.com/DanielHernandezTalla/FirstClassNavojoa',
      FigmaDesign:
        'https://www.figma.com/file/j71EliTPFeC4vmw0jiWfMn/Dise%C3%B1o-SFC?node-id=0%3A1&t=46ZzDF4fYmu4gkiE-1',
      Collaborators: [
        {
          name: 'DanielHernandezTalla',
          icon: 'https://avatars.githubusercontent.com/u/62040086?v=4',
          profile: 'https://github.com/DanielHernandezTalla'
        },
        {
          name: 'BriandaCampoy',
          icon: 'https://avatars.githubusercontent.com/u/62039999?v=4',
          profile: 'https://github.com/BriandaCampoy'
        }
      ],
      deploy: ''
    },
    ...
    },
    {
      ...
      description:
        '### ¿What is ACTI-React-App?\n\nACTI is a workshop for students of Software Engineering in ITSON.  This system was made for the students of this workshop. Every student has an account and there they can see the different courses offered by ACTI, each course has several challenges designed for students to practice a specific technology. After resolving the challenges, the students can present an exam. If they approve the exam, they level up. Once they have the maximum level, they could become administrators. The system administrators can register new users and schedule exams for the students. They can also manage resources, recommendations, and announcements for the students.\n\n#### Technical details.\n* The system was made with React, using react-router-dom for navigation.\n* The system counts with its own API and database, the API was made with Node, and the database with MongoDB.',
      images: [
      ...
      GithubRepository: '',
      FigmaDesign:
        'https://www.figma.com/file/VYWbAkGhOxVUQQqquJ3Jkv/ACTIReactApp?node-id=0%3A1&t=tBSODLGBlfLThCg0-1',
      Collaborators: [
        {
          name: 'Legend299',
          icon: 'https://avatars.githubusercontent.com/u/64448236?v=4',
          profile: 'https://github.com/Legend299'
        },
        {
          name: 'BriandaCampoy',
          icon: 'https://avatars.githubusercontent.com/u/62039999?v=4',
    ...
    },
    {
      ...
      description:
        'This web app shows all the Pokemon provide by pokeapi.co, it was made with react and uses react-router-dom for navigation. The users can search a pokemon by name and check some details about it.\nAnd to make the load better, it has a loading skeleton for the pokemon cards.',
      images: [
    ...
    {
      id: 9,
      name: 'Landing page Distribuidora Industrial Navojoa',
      ...
      Technologies: [3, 7, 1],
      GithubRepository:
        'https://github.com/Acti-isw/DistribuidoraIndustrialNavojoaWebsite',
      FigmaDesign:
        'https://www.figma.com/file/sB5rRxnhVnGb72wxJgZUGN/DINAV?node-id=0%3A1&t=W3n1lNlxeiTfeaVU-1',
      Collaborators: [],
    ...
    },
    {
      ...
      description:
        'Qmiro is a web application made as a React practice.\nIt is connected to the API TheMovieDB. It uses React-route-dom for navigation.\n\nOn this page, you can:\n* Search movies by name.\n* Take a look at the list of the most popular movies and series at that moment.\n* Take a look at movies of a specific gender.\n* See the details of a specific movie or series.\n* Mark a movie or series as a favorite.',
      images: [
      ...
      FigmaDesign:
        'https://www.figma.com/file/eBcLBlNRVZBYhJle5PetB9/Qmiro?node-id=0-1&t=C4c7Q5XfydwZ2llZ-0',
      Collaborators: [],
    ...
    },
    {
      ...
      description:
        'This is a quite simple web application connected to thecatapi.com as a service.\nOn this page, you can:\n* See random cute cats.\n* Add cute cats to your favorites.\n* Upload photos of your own cats.',
      images: [
    ...
    },
    {
      ...
      description:
        'TODO machine is a classic web application to list tasks and marks them as done.',
      images: [
    ...
    },
    {
      ...
      description:
        "An animation game is a game made with CSS animations and JS. \nThe game consists in touch the cats to get points and that's it. ",
      images: [
    ...
    },
    {
      ...
      description:
        'This landing page can get the last videos of Nunca Jamas Band from the API of YouTube.',
      images: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681696753/portfolio/assets/img_projects/Asynclanding_z9zgj7.png'
      ],
      Technologies: [1, 3],
      GithubRepository: '',
      FigmaDesign: '',
    ...
    },
    {
      ...
      description:
        '### ¿What is Modelador UML?\nIt is a modeler to create robustness diagrams.\n A robustness diagram can be composed of controls, boundaries, entities, uses cases, and actors. And they can have associations between them.\nUsers can create diagrams like every other modeler application, but this modeler has the singularity that users can not do invalid connections between components.\n',
      images: [
      ...
      Collaborators: [
        {
          name: 'gborrego-potros',
          icon: 'https://avatars.githubusercontent.com/u/83464777?s=200&v=4',
          profile: 'https://github.com/gborrego-potros'
        },
        {
          name: 'abrs98',
          icon: 'https://avatars.githubusercontent.com/u/54648173?v=4',
          profile: 'https://github.com/abrs98'
        },
        {
          name: 'DanielHernandezTalla',
          icon: 'https://avatars.githubusercontent.com/u/62040086?v=4',
    ...
    },
    {
      ...
      description:
        "It's an application idea developed to fulfill the function of and special kind of schedule made to help students to manage their time between school classes and their homework.\nIt is just a prototype make with HTML and CSS.",
      images: [
      ...
      GithubRepository: '',
      FigmaDesign:
        'https://www.figma.com/file/apFuV4dmZr38ZaIq2fqGne/Untitled?node-id=0-1&t=6suh4OU2lQZkAO7X-0',
      Collaborators: [],
      deploy: ''
    },
    {
      ...
      description: 'A visual clone of the classic google.',
      images: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681696562/portfolio/assets/img_projects/googleClone1_s0tuat.png'
      ],
      Technologies: [3, 7],
    ...
    },
    {
      ...
      description:
        '### What is Navojoa Como Vamos?\nNavojoa Como Vamos is a civil organization, that needed a page to show information about its organization also on this page, citizens can make reports about some problems in the municipality like lack of public lighting or rubbish in the streets.\n\nThe reports count with the following properties:\n* Title\n* Description\n* Pictures\n* Location\n* Date\n* Days passed of the report\n* How many times the report has been presented by different citizens.',
      images: [
      ...
      GithubRepository: '',
      FigmaDesign:
        'https://www.figma.com/file/kzuSsPuMnFfJwUhZVhEyhx/Navojoa-%C2%BFC%C3%B3mo-Vamos%3F?node-id=2210%3A721&t=cOHNJZbWHzWkonHV-1',
      Collaborators: [
        {
          name: 'Legend299',
          icon: 'https://avatars.githubusercontent.com/u/64448236?v=4',
    ...
    },
    {
      ...
      description:
        'It is a CRUD made with EJS, the crud is a list of students that can be passed or failed.\n It is also made with Bootstrap styles.\n',
      images: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681696847/portfolio/assets/img_projects/Ejs/ejs1_vsnwla.png'
      ],
      Technologies: [1, 15],
    ...
    },
    {
      ...
      description:
        "It is a React practice using useReducer, ClassState, and useState.\nThe security code is 'paradigma'",
      images: [
      ...
      Technologies: [1, 2, 7],
      GithubRepository:
        'https://github.com/BriandaCampoy/React-practice-securityCode',
      FigmaDesign: '',
      Collaborators: [],
    ...
    },
    {
      ...
      description: 'It gets random users from an API',
      images: [
      ...
      FigmaDesign: '',
      Collaborators: [],
      deploy: 'https://dainty-mochi-6ab6f4.netlify.app/'
    },
    {
      id: 21,
      ...
      description:
        'It is a React practice using rickandmortyapi.com as a service.\nIt uses some hooks like useState, useReducer, useMemo, useRef, useContext and useCallback.\nWith this you can:\n* See the first 20 results of the API\n* Mark a temporary list of favorites\n* Search characters by name.',
      images: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1681696603/portfolio/assets/img_projects/RmApi_zh3yxz.png'
      ],
      Technologies: [1, 2, 7],
    ...
    {
      id: 23,
      name: 'TextToStringConverter',
      icon: 'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1682722828/portfolio/assets/img_projects/TextToStringConverter/Frame_31_ml0ovz.svg',
      description:
        'It was made to convert Markdown text to a format easy to save in a string.\nIn this way, I can save Markdown on my databases as a string to use it later with the same format on my web pages.',
      images: [
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1682722529/portfolio/assets/img_projects/TextToStringConverter/TextToString_glpuyc.png',
        'https://res.cloudinary.com/dtn1pnbmu/image/upload/v1682722492/portfolio/assets/img_projects/TextToStringConverter/TextToString_xd8gwa.png'
      ],
      Technologies: [1, 3, 7],
      GithubRepository:
        'https://github.com/BriandaCampoy/TextToStringConverter',
      FigmaDesign: '',
      Collaborators: [],
      deploy: 'https://briandacampoy.github.io/TextToStringConverter/'
    },
    {
      id: 24,
      name: '',
